...
xml.onreadystatechange = () => {
  if (xml.readyState == 4 && xml.status == 200) {
    xmlToolbox = new XMLSerializer().serializeToString(xml.responseXML);
    // let xmlString = new XMLSerializer().serializeToString(xml.responseXML);
    // console.log(xmlString);
    // document.getElementById('blocks_xml').innerHTML += xmlString;
  }
};
